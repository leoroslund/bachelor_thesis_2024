...
def battery_capacity(data: pd.DataFrame) -> None:
    ...
    if setting == "(grävmaskin)":
        plt.plot(24550, 264, "ro", label="EC230 Electric")
    elif setting == "(hjullastare)":
        plt.plot(20300, 237, "ro", label="L120H Electric Conversion")
...
if __name__ == "__main__":
    ...
    print(f"{(1050-(6*160))/4=}")
    print(f"{(1840-(6*283))/4=}")
